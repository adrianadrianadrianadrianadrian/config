...
hi StatusLine guifg=#000000 guibg=#dadada gui=NONE cterm=NONE
...
hi Todo guifg=#00ffaf guibg=NONE gui=NONE,reverse cterm=NONE,reverse
...
if s:t_Co >= 256
  ...
  hi Todo ctermfg=49 ctermbg=NONE cterm=NONE,reverse
...
if s:t_Co >= 16
  ...
  hi Todo ctermfg=NONE ctermbg=NONE cterm=NONE,reverse
